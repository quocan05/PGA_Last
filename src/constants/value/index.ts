...
export enum API_PGA {
  ...
  FORGOT_PASSWORD = "https://api-training.hrm.div4.pgtest.co/api/v1/forgot-password",
  RESET_PASSWORD = "https://api-training.hrm.div4.pgtest.co/api/v1/reset-password",
  ...
  CHANGE_PASSWORD = "https://api-training.hrm.div4.pgtest.co/api/v1/change-password",
